 ...
 */
public class SubBancoGenFragment extends Fragment {
    ...
    public static SubBancoGenFragment newInstance(String param1, String param2) {
        SubBancoGenFragment fragment = new SubBancoGenFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sublistaadapter = new SubDataAdapter(SubBancoGenFragment.this.getActivity(), subdeptlist);
    ...
    private void LoadData(){
        ...
        addProduct("Niveles","Curvas Inferiores");

 ...
 */
public class SubEconomizadorFragment extends Fragment {
    ...
    public static SubEconomizadorFragment newInstance(String param1, String param2) {
        SubEconomizadorFragment fragment = new SubEconomizadorFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sublistaadapter = new SubDataAdapter(SubEconomizadorFragment.this.getActivity(), subdeptlist);
    ...
    private void LoadData(){
        ...
        addProduct("Economizador -1","Curvas Inferiores");
        addProduct("Economizador -1","Entrada de Deshollinadores");

        addProduct("Economizador -2","Curvas Inferiores");
        addProduct("Economizador -2","Entrada de Deshollinadores");
